...
export const BRANDS_OPTIONS = ['adidas Originals', 'adidas Performance', 'adidas Sportswear', 'Nike Performance', 'Nike SB', 'Nike Sportswear', 'Puma', 'New Balance', 'Vans', 'Converse', 'Jordan'];
